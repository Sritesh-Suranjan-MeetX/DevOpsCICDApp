...
android {
    namespace = "com.example.devopscicdapp"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.devopscicdapp"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    signingConfigs {
        create("release") {
            storeFile = file(project.findProperty("releaseKeystoreFile") as String? ?: "debug.keystore")
